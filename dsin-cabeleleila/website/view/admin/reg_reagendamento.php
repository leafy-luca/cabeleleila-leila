...
try {
    ...
    echo "<script>alert('Reagendamento realizado com sucesso!'); window.location.href = 'dashboard.php';</script>";
} catch (Exception $e) {
    $pdo->rollBack();
    echo "<script>alert('Erro ao reagendar: " . $e->getMessage() . "'); window.location.href = 'dashboard.php';</script>";
}
?>
